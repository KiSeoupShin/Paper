...
class YoloPascalVocDatatset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        # Process bounding boxes into the S x S x (5 * B + C) ground truth tensor
        boxes = {}
...
if __name__ == '__main__':
    ...
    train_set = YoloPascalVocDatatset('train', normalize=True, augment=True)
