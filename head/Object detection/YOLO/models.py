...
class Yolov1ResNet(nn.Module):
    def __init__(self):
        ...
        # Delete last two layers and attahc detection layers
...
class DetectionNet(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        self.model = nn.Sequential(
            ...
            nn.Conv2d(inner_channels, inner_channels, kernel_size=3, padding=1),   # (Ch, 14, 14) -> (Ch, 7, 7)
            nn.LeakyReLU(negative_slope=0.1),
...
class Yolov1(nn.Module):
    def __init__(self):
        super().__init__()
        self.depth = config.S * 5 + config.C
